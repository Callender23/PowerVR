...
******************************************************************************/
class OpenGLESPointLighting : public pvr::Shell
{
...
void OpenGLESPointLighting::eventMappedInput(pvr::SimplifiedInput action)
{
...
pvr::Result OpenGLESPointLighting::initApplication()
{
	_triangle1.SetPosition(0, 0, 0);
...
pvr::Result OpenGLESPointLighting::quitApplication() {
	return pvr::Result::Success;
}

pvr::Result OpenGLESPointLighting::initView()
{
	...
	_uiRenderer.getDefaultTitle()->setText("OpenGL ES Point Lighting");
...
pvr::Result OpenGLESPointLighting::releaseView() {
	return pvr::Result::Success;
}

pvr::Result OpenGLESPointLighting::renderFrame()
{
...
std::unique_ptr<pvr::Shell> pvr::newDemo() { return std::unique_ptr<pvr::Shell>(new OpenGLESPointLighting()); }
