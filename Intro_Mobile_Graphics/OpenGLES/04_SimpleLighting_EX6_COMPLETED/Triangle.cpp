...
const char* TriangleUniformNames[] = { "uMVPMatrix", "uMVITMatrix", "uLightDirection", "uLightColour" };
...
void Triangle::Update(float yAxisRotation) { _rotation *= glm::rotate(yAxisRotation, glm::vec3(0, -1, 0)); }

void Triangle::Render(const glm::mat4& view, const glm::mat4& projection, const glm::vec3& lightDirection, const glm::vec4& lightColour)
{
