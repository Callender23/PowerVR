...
const char TextureFile2[] = "Image2.pvr";
const char TextureFile3[] = "Image3.pvr";
...
pvr::Result OpenGLESIntroducingPVRUtils::initView()
{
	...
	_uiRenderer.getDefaultTitle()->setText("Texturing");
	_uiRenderer.getDefaultTitle()->commitUpdates();

	// Sets the clear color
	gl::ClearColor(0.6f, 0.8f, 1.0f, 1.0f);

	if (!_triangle.Init(this, _context, TextureFile))
	{
	...
	if (!_square.Init(this, _context, TextureFile3))
	{
		throw pvr::InvalidDataError(" ERROR: Square failed in Init()");
		return pvr::Result::UnknownError;
	}
