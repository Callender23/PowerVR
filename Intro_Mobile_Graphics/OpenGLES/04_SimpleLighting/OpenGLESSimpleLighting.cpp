...
pvr::Result OpenGLESSimpleLighting::renderFrame()
{
	...
	*/
	...
	/*
	Draw a triangle - we pass the View and Projection matrices and the light direction to the triangles
	*/
	_triangle1.Render(_view, _projection, _lightDirection);
	_triangle2.Render(_view, _projection, _lightDirection);
